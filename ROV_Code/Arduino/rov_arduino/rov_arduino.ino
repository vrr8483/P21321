...
void loop() {
  ...
  while (Serial3.available()){
	...
	case sensor3_id:
	  ...
	  break;
        case sensor4_id:
	  sensor4.value = sensor_cmd_packet.cmd.value;
	  break;
	default:
      ...
      if (!found_header){
        ...
        buffer_position = 0;
        Serial3.println("Invalid packet.");
      }
